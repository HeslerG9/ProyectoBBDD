	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de matrícula <small>   Lista de docentes</small></h1>
            </div>
        </div>
		...
		<div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
				...
				Si desea registrar un nuevo Docente ve a la seccion de "Registrar Usuarios"
                </div>
            </div>
		</div>
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list" style="background-color:#DFF0D8; font-weight:bold;">
                            <div class="div-table-cell" style="width: 5%;">#Empleado</div>
                            <div class="div-table-cell" style="width: 10%;">Nombres</div>
                            ...
                            <div class="div-table-cell" style="width: 12%;">Docente de</div>
                            <div class="div-table-cell" style="width: 12%;">Título</div>
                            <div class="div-table-cell" style="width: 6%;">Eliminar</div>
                        </div>
                    </div>
                </div>
                <div class="table-responsive">
                    <div id="div-table-docentes" class="div-table" style="margin:0 !important;">
