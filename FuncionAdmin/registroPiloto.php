...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de registro <small> Registrar Piloto</small></h1>
            </div>
        </div>
        ...
        <div class="row my-1">
            <?php
                include("registro/formularios/formulario-piloto.html");
			?>
    ...
    <!--====== Scripts -->
    <script src="registro/js/piloto.js"></script>
